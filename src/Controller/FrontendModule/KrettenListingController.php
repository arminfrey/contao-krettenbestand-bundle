...
namespace Arminfrey\ContaoKrettenbestandBundle\Controller\FrontendModule;
...
#[AsFrontendModule(category: 'kretten_module', template: 'mod_kretten_listing')]
class KrettenListingController extends AbstractFrontendModuleController
{
    public const TYPE = 'kretten_listing';
